...
const TRANSLATIONS: Dictionary = {
	"en": {
		...
		"LBL_ENDLESS_SURVIVAL": "ENDLESS SURVIVAL BATTLE",
		"LBL_ENDLESS_DISTANCE": "Distance  %dm  vs  %dm",
		"LBL_KRATIPS": "Kratips  P1 %d  vs  P2 %d",
		"LBL_SKILLS_USED": "Skills Used  P1 %d  vs  P2 %d",
	...
	"th": {
		...
		"LBL_ENDLESS_SURVIVAL": "การต่อสู้เอาชีวิตรอดไม่มีที่สิ้นสุด",
		"LBL_ENDLESS_DISTANCE": "ระยะทาง  %dm  vs  %dm",
		"LBL_KRATIPS": "กระติ๊บ  P1 %d  vs  P2 %d",
		"LBL_SKILLS_USED": "ใช้สกิล  P1 %d  vs  P2 %d",
